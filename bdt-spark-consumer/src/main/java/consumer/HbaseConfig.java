   ...
   Configuration config = HBaseConfiguration.create();
  		...
  		public void createTable(String... args) throws IOException
  		{
  			try
  	        {
  	            ...
  	            table.addFamily(new HColumnDescriptor(CF_HASH).setCompressionType(Algorithm.NONE));
  			    table.addFamily(new HColumnDescriptor(CF_COUNT).setCompressionType(Algorithm.NONE));
